          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="bio" defaultValue="Computer Science student with a passion for web development." />
              </div>
            </CardContent>
            <CardFooter>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Receive email notifications about job applications.</p>
                </div>
        ...
        <TabsContent value="privacy" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Control your privacy settings and what information is visible to recruiters.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
