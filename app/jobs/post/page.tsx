...
export default function PostJobPage() {
  ...
  const nextTab = () => {
    ...
    else if (activeTab === "requirements") setActiveTab("preview")
  }

  const prevTab = () => {
    if (activeTab === "requirements") setActiveTab("details")
    else if (activeTab === "preview") setActiveTab("requirements")
  }
  ...
  const handleSubmit = async (isDraft = false) => {
    ...
    try {
      // Validate form
      if (!isDraft && (!title || !company || !location || !description || !deadline)) {
        toast({
          variant: "destructive",
  ...
  return (
    <AuthGuard allowedRoles={["recruiter", "admin"]}>
      <div className="max-w-4xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid grid-cols-3 mb-8 bg-gradient-to-r from-cyan-50 to-blue-50 p-1">
            <TabsTrigger
              value="details"
              className={activeTab === "details" ? "bg-gradient-to-r from-cyan-600 to-blue-700 text-white" : ""}
            >
            ...
            <TabsTrigger
              value="requirements"
              className={activeTab === "requirements" ? "bg-gradient-to-r from-cyan-600 to-blue-700 text-white" : ""}
            >
            ...
            <TabsTrigger
              value="preview"
              className={activeTab === "preview" ? "bg-gradient-to-r from-cyan-600 to-blue-700 text-white" : ""}
            >
          ...
          <TabsContent value="details">
            <Card className="border-t-4 border-t-cyan-500 shadow-md">
              ...
              <CardFooter className="flex justify-between bg-gradient-to-r from-cyan-50 to-blue-50 border-t">
                <Button variant="outline" onClick={() => router.push("/jobs/manage")}>
                  Cancel
                </Button>
                <Button onClick={nextTab} className="bg-gradient-to-r from-cyan-600 to-blue-700 hover:opacity-90">
                  Next: Requirements
                </Button>
              </CardFooter>
            </Card>
